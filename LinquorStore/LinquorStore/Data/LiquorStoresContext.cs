...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=WINDOWS-11;Database=LiquorStores;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DatHang>(entity =>
            {
                entity.HasOne(d => d.KhachHang)
                    ...
                    .HasConstraintName("FK__DatHang__KhachHa__33D4B598");

                entity.HasOne(d => d.TaiKhoan)
                    .WithMany(p => p.DatHangs)
                    .HasForeignKey(d => d.TaiKhoanId)
                    .HasConstraintName("FK__DatHang__TaiKhoa__34C8D9D1");
            });
            ...
            modelBuilder.Entity<DatHangChiTiet>(entity =>
            {
                entity.HasOne(d => d.DatHang)
                    ...
                    .HasConstraintName("FK__DatHang_C__DatHa__35BCFE0A");

                entity.HasOne(d => d.SanPham)
                    .WithMany(p => p.DatHangChiTiets)
                    .HasForeignKey(d => d.SanPhamId)
                    .HasConstraintName("FK__DatHang_C__SanPh__36B12243");
            });
            ...
            modelBuilder.Entity<SanPham>(entity =>
            {
                entity.HasOne(d => d.Hang)
                    ...
                    .HasConstraintName("FK__SanPham__Hang_ID__37A5467C");

                entity.HasOne(d => d.Loai)
                    .WithMany(p => p.SanPhams)
                    .HasForeignKey(d => d.LoaiId)
                    .HasConstraintName("FK__SanPham__Loai_ID__38996AB5");

                entity.HasOne(d => d.NoiSanXuat)
                    .WithMany(p => p.SanPhams)
                    .HasForeignKey(d => d.NoiSanXuatId)
                    .HasConstraintName("FK__SanPham__NoiSanX__398D8EEE");
            });
